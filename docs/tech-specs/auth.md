...
| --- | --- |
| `USER_DATA` | Read-only account endpoints (`/account`, `/account/balances`, `/prediction/orders`) |
| `TRADE` | Order placement and cancellation (`/prediction/order`, `/prediction/batchOrders`, `/prediction/openOrders DELETE`) |
