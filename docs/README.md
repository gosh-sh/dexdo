...
| [tech-specs/write-api.md](tech-specs/write-api.md) | All write endpoints: `POST/DELETE /order`, `POST/DELETE /batchOrders`, `DELETE /openOrders`, `POST /buyFullSet` | Dev1 |
...
- [contract-specs/](contract-specs/) — on-chain DEX.DO contracts. Event routing in [dex-events-routing.md](contract-specs/dex-events-routing.md); flow/object diagrams as HTML and drawio. The AI-inference registry is split in two: the protocol, deploy specifics, root provisioning and e2e harness in [airegistry-inference.md](contract-specs/airegistry-inference.md), the method-by-method wrapper reference in [airegistry-sdk.md](contract-specs/airegistry-sdk.md).
