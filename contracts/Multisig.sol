...
contract Multisig {
    ...
    struct Transaction {
        ...
        bool bounce;
        // Destination dapp_id. Provided by the caller and stored, but NOT used
        // when actually sending the message (kept for off-chain/API purposes).
        uint256 dapp_id;
    }
    ...
    */
    ...
    {
        dapp_id; // accepted & part of the API, but intentionally unused when sending
